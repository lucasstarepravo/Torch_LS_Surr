...
def run_model(path_to_data, layers, ID, nprocs, model_type, path_to_save='./data_out'):
    ...
    mp.spawn(ann.fit, args=(nprocs, path_to_save, model_type, ID), nprocs=nprocs)
    ...
    evaluate_model(model_path, attrs, model_instance, test_features, test_labels, polynomial, ID, path_to_save)
